...
public class TestProxy {
    ...
    public static void main(String[] args) {
        ...
        Apartment apartmentForStudent1 = proxy.rent(student01);
        System.out.println(student01+" rented "+ apartmentForStudent1);

        Apartment apartmentForStudent2 = proxy.rent(student02);
        System.out.println(student02+" rented "+ apartmentForStudent2);
    }
}
