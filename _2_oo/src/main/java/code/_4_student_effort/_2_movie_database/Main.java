...
public class Main {
    ...
    public static void varstapeste50() {
        for (Studio studio : detalii()) {
            for (Film film : studio.filme) {
                for (Actor actor : film.actori) {
                    if (actor.varsta > 50) {
    ...
    public static void main(String[] args) {
       System.out.println("Studiourile care au publicat mai mult de 2 filme sunt: " );
       filme();
       System.out.println("Studiourile care au avut actori cu 2 oscaruri sunt: " );
       oscaruri();
       System.out.println("Filmele cu actori cu varsta de peste 50 de ani sunt: " );
       varstapeste50();
