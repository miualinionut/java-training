...
public class Main {
    ...
    public static void printStudioMoreThan2Movies() {
    ...
    public static void printStudioActorCu2oscaruri() {
        for (Studio studio : getData()) {
    ...
    public static void printMovieActorWithAgeAbove50() {
        for (Studio studio : getData()) {
            for (Film film : studio.filme) {
                for (Actor actor : film.actori) {
                    if (actor.varsta > 50) {
    ...
    public static void main(String[] args) {
        ...
        printStudioMoreThan2Movies();
        printStudioActorCu2oscaruri();
        printMovieActorWithAgeAbove50();
    }
}
