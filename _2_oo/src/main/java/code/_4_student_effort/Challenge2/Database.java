    ...
    public class Database {
        ...
        public static void printStudioNamesInWhichPlaysTheActorWithNameActorCu2Oscaruri() {
        ...
        public static void printMovieNamesInWhichPlaysAtLeastAnActorWithAgeAbove50() {
            for (Studio studio : getData()) {
                for (Film film : studio.filme) {
                    for (Actor actor : film.actori) {
                        if (actor.varsta > 50) {
        ...
        public static void main(String[] args) {
            ...
            printStudioNamesInWhichPlaysTheActorWithNameActorCu2Oscaruri();
            printMovieNamesInWhichPlaysAtLeastAnActorWithAgeAbove50();
        }
    }
