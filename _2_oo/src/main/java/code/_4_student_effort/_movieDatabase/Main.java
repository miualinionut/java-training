...
public class Main {
    public static void main(String[] args) {
        ...
        Actor actorOscar2018 = new Actor("actor cu oscar din 2018", 33,
        ...
        Film film4 = new Film(2018, "film cu actori de oscar",
                new Actor[]{actorOscar2010, actorFaraPremii02, actorOscar2018});
        Film film5 = new Film(2018, "film cu actori fara premii3",
        ...
        System.out.println(dataBase.NamesStudioMore2Movies(studioDatabase));

        System.out.println((dataBase.NamesStudioActor2Oscars(studioDatabase)));

        Film [] films = {film1, film2, film3, film4, film5};
        System.out.println((dataBase.MovieNamesActors(films)));
