...
public class Registru {
    public static Studio[] obtainData() {
        ...
        Film film5 = new Film(2018, "film cu actori fara premii3", new
                Actor[]{actorFaraPremii02, actorFaraPremii03});

        Studio studio1 = new Studio("MGM", new Film[]{film1, film2});
        Studio studio2 = new Studio("Disney", new Film[]{film3, film4, film5});

        Studio[] studioRegistru = new Studio[]{studio1, studio2};
        return studioRegistru;


    }

    public static void studioMoreThan2Movies() {
        for (Studio studio : obtainData()) {
    ...
    public static void studioWithActorCu2Oscaruri() {
        for (Studio studio : obtainData()) {
    ...
    public static void movieNamewithAtLeastOneActorAbove50() {
        for (Studio studio : obtainData()) {
            for (Film filme : studio.filme) {
                for (Actor actor : filme.actori) {
                    if (actor.varsta > 50) {
                        System.out.println(filme.nume);
                    }
                }
            }
        }
    ...
    public static void main(String[] args) {
        studioMoreThan2Movies();
        studioWithActorCu2Oscaruri();
        movieNamewithAtLeastOneActorAbove50();
    }
}
