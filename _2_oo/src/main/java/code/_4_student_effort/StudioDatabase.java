...
public class StudioDatabase {
    public static void main(String[] args) {
        ...
        Premiu oscar2010=new Premiu("oscar",2018);
        ...
        Film film3 =new Film(2018,"film cu actori fara premii 3",new Actor[]{actorFaraPremii01,actorFaraPremii02,actorFaraPremii03});
        ...
        //Query1- studio that published more than two movies:

        System.out.println("QUERY 1:");
        for(Studio s: studioDatabase){
            if(s.filme.length>2) System.out.println(s.nume);
        }

        //Query2- studio containing the actor named "actor cu 2 oscaruri":
        ...
        //Query3- movies in which plays at least an actor with age above 50
