...
public class Main {
    public static void main(String[] args) {
        ...
        // Get the studio names in which plays the actor with name "actor cu 2 oscaruri"
        System.out.println("\nStudios in which plays the actor with name \"actor cu 2 oscaruri\":");
        for(Studio studio : studioDatabase){
        ...
        // Get movie names in which plays at least an actor with age above 50
        System.out.println("\nMovies in which plays the actor with age above 50:");
        for(Studio studio : studioDatabase){
            for(Film film : studio.getFilme()){
                for(Actor actor : film.getActori()){
