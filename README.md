Pentru a gasi proiectul final, intrati in: clean_code_projects -> _1_project_requirements_chess -> src -> main/java/clean/code/chess/requirements -> ChessBoard.java si Pawn.java.
