...
public class Main {
    ...
    public static void getStudiosWithMoreThanTwoMovies(){
            Studio[] studios = getStudios();
    ...
    public static void getStudiosWithActor(){
        Studio[] studios = getStudios();
        for(Studio s : studios) {
           for(Film f : s.filme) {
    ...
    public static void main(String[] args) {
        ...
        getStudiosWithMoreThanTwoMovies();
        System.out.println("Studios with actor cu 2 oscaruri");
        getStudiosWithActor();
        System.out.println("Movies with actor above 50");
        getMovies();
    }
}
